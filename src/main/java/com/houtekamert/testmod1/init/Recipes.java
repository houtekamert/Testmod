...
public class Recipes
{
    public static void init()
    {
        ...
        //tools
        GameRegistry.addRecipe(new ItemStack(ModItems.qbsword), " s ", " s ", "t", 's', new ItemStack(ModItems.qbsteel), 't', new ItemStack(ModItems.ebstick));
        GameRegistry.addRecipe(new ItemStack(ModItems.qbpick), "sss", " t ", " t ", 's', new ItemStack(ModItems.qbsteel), 't', new ItemStack(ModItems.ebstick));
        GameRegistry.addRecipe(new ItemStack(ModItems.qbaxe), "ss ", "st ", "t", 's', new ItemStack(ModItems.qbsteel), 't', new ItemStack(ModItems.ebstick));
        GameRegistry.addRecipe(new ItemStack(ModItems.qbshovel), " s ", " t ", "t", 's', new ItemStack(ModItems.qbsteel), 't', new ItemStack(ModItems.ebstick));
        GameRegistry.addRecipe(new ItemStack(ModItems.qbhoe), "ss ", " t ", "t", 's', new ItemStack(ModItems.qbsteel), 't', new ItemStack(ModItems.ebstick));
