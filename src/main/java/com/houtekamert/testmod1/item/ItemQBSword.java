...
public class ItemQBSword extends ItemSword
{
    public ItemQBSword(ToolMaterial material)
    {
        super(material);
        this.setUnlocalizedName("qbsword");
        this.setTextureName(Reference.MOD_ID + ":" + "qbsword");
