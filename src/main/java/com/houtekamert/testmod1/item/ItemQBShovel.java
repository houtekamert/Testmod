...
public class ItemQBShovel extends ItemSpade
{
    public ItemQBShovel(ToolMaterial material)
    {
        super(material);
        this.setUnlocalizedName("qbshovel");
        this.setTextureName(Reference.MOD_ID + ":" + "qbshovel");
